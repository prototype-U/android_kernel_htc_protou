...
#else
#define	S5K4E5YX_TOTAL_STEPS_NEAR_TO_FAR			52
#endif
...
DEFINE_MUTEX(s5k4e5yx_act_mutex);
static struct msm_actuator_ctrl_t s5k4e5yx_act_t;
...
static struct region_params_t g_regions[] = {
	...
	/* Region 1 */
	{
		.step_bound = {S5K4E5YX_TOTAL_STEPS_NEAR_TO_FAR, 0},
		.code_per_step = 2,
	},
};
...
static uint16_t g_scenario[] = {
	...
	S5K4E5YX_TOTAL_STEPS_NEAR_TO_FAR,
};
...
static struct msm_actuator_info *s5k4e5yx_msm_actuator_info;

static int32_t s5k4e5yx_poweron_af(void)
{
	int32_t rc = 0;
	pr_info("%s enable AF actuator, gpio = %d\n", __func__,
			s5k4e5yx_msm_actuator_info->vcm_pwd);
	rc = gpio_request(s5k4e5yx_msm_actuator_info->vcm_pwd, "s5k4e5yx");
	if (!rc) {
		gpio_direction_output(s5k4e5yx_msm_actuator_info->vcm_pwd, 1);
		msleep(20);
	} else {
...
int32_t s5k4e5yx_msm_actuator_move_focus(struct msm_actuator_ctrl_t *a_ctrl,
...
int s5k4e5yx_actuator_af_power_down(void *params)
{
	int rc = 0;
	LINFO("%s called\n", __func__);

	rc = (int) msm_actuator_af_power_down(&s5k4e5yx_act_t);
	s5k4e5yx_poweroff_af();
	return rc;
}
...
int32_t s5k4e5yx_act_write_focus(
	struct msm_actuator_ctrl_t *a_ctrl,
...
static int32_t s5k4e5yx_act_init_focus(struct msm_actuator_ctrl_t *a_ctrl,
...
static const struct i2c_device_id s5k4e5yx_act_i2c_id[] = {
	{"s5k4e5yx_act", (kernel_ulong_t)&s5k4e5yx_act_t},
	{ }
};
...
{
	LINFO("%s called\n", __func__);
	return (int) msm_actuator_config(&s5k4e5yx_act_t, argp);
}
...
static struct i2c_driver s5k4e5yx_act_i2c_driver = {
	.id_table = s5k4e5yx_act_i2c_id,
	.probe  = msm_actuator_i2c_probe,
	.remove = __exit_p(s5k4e5yx_act_i2c_remove),
	.driver = {
		.name = "s5k4e5yx_act",
	},
};
...
static struct v4l2_subdev_core_ops s5k4e5yx_act_subdev_core_ops = {
	.ioctl = msm_actuator_subdev_ioctl,
	.s_power = msm_actuator_power,
};
/* HTC_END */

static struct v4l2_subdev_ops s5k4e5yx_act_subdev_ops = {
	.core = &s5k4e5yx_act_subdev_core_ops,
};

static int32_t s5k4e5yx_act_create_subdevice(
	void *board_info,
	void *sdev)
{
	LINFO("%s called\n", __func__);

	s5k4e5yx_msm_actuator_info = (struct msm_actuator_info *)board_info;

	return (int) msm_actuator_create_subdevice(&s5k4e5yx_act_t,
		s5k4e5yx_msm_actuator_info->board_info,
		(struct v4l2_subdev *)sdev);
}

static struct msm_actuator_func_tbl s5k4e5yx_act_func_tbl = {
	.actuator_init_table = s5k4e5yx_msm_actuator_init_table,
	.actuator_move_focus = s5k4e5yx_msm_actuator_move_focus,
	.actuator_write_focus = s5k4e5yx_act_write_focus,
	.actuator_set_default_focus = msm_actuator_set_default_focus,
	.actuator_init_focus = s5k4e5yx_act_init_focus,
	.actuator_i2c_write = s5k4e5yx_wrapper_i2c_write,
};

static struct msm_actuator_ctrl_t s5k4e5yx_act_t = {
	.i2c_driver = &s5k4e5yx_act_i2c_driver,
	.i2c_addr = REG_VCM_I2C_ADDR,
	.i2c_data_type = MSM_CAMERA_I2C_BYTE_DATA, /* HTC Angie 20120615 */
	.act_v4l2_subdev_ops = &s5k4e5yx_act_subdev_ops,
	.actuator_ext_ctrl = {
		.a_init_table = s5k4e5yx_i2c_add_driver_table,
		.a_power_down = s5k4e5yx_actuator_af_power_down,
		.a_create_subdevice = s5k4e5yx_act_create_subdevice,
		.a_config = s5k4e5yx_act_config,
	},
	...
	.set_info = {
		.af_tuning_params.total_steps = S5K4E5YX_TOTAL_STEPS_NEAR_TO_FAR,
		//.gross_steps = 3,	/*[TBD]*/
		//.fine_steps = 1,	/*[TBD]*/
	},
	...
	.curr_region_index = 0,
	.initial_code = 0,	/*[TBD]*/
	.actuator_mutex = &s5k4e5yx_act_mutex,

	.func_tbl = &s5k4e5yx_act_func_tbl,
...
subsys_initcall(s5k4e5yx_i2c_add_driver);
MODULE_DESCRIPTION("S5K4E5YX actuator");
