...
#if ((defined CONFIG_MACH_PROTOU) || (defined CONFIG_MACH_PROTODUG) || (defined CONFIG_MACH_PROTODCG) || defined(CONFIG_MACH_MAGNIDS))
...
*/
			...
			if (mdp_lose_color_setting()) {
				/* ProtoU met the problem which the device will keep in the black screen after high temperature PA testing */
				/* We found the following register will be 0 on the fail device */
				/* So I will check the 0x93684, 0x9368C and 0x93694 offset register by above mdp_lose_color_setting() */
				/* If some above register was 0, I will restore this color enhancement table */
				/* NOTE: this table should sync with "arch\arm\mach-msm\display\board-protou-panel.c" file */
				const struct mdp_reg protou_color_v105[] = {
					{0x93400, 0x0211, 0x0},
					{0x93404, 0xFFF2, 0x0},
					{0x93408, 0xFFFF, 0x0},
					{0x9340C, 0xFFF8, 0x0},
				...
				printk(KERN_ERR "[DISP] msm_fb_blank_sub: Found color enhancement value missing!\n");
